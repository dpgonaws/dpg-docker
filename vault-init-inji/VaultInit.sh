...
kubectl create secret generic vault-unseal-key --from-literal=VAULT_UNSEAL_KEY=$VAULT_UNSEAL_KEY -n $NAMESPACE
...
kubectl create secret generic vault-cluster-token --from-literal=ROOT_TOKEN=$CLUSTER_ROOT_TOKEN -n $NAMESPACE
